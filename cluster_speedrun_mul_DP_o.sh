...
srun torchrun --nnodes=2 --nproc_per_node=$NPROC_PER_NODE --rdzv_backend=c10d --rdzv_endpoint=$MASTER_ADDR:$MASTER_PORT -m scripts.base_train_DP_o -- --depth=16 --device_batch_size=2 --num_iterations=70 --run=$WANDB_RUN
